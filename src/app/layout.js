...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="en">
      <head>
        <title>Velora — Premium Dropshipping Store</title>
        <meta name="description" content="Discover trending products shipped directly to your door across the USA. Fast shipping, quality goods, unbeatable prices." />
      </head>
      <body>
        <CartProvider>
          {!isAdmin && <Header />}
